/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: e4beb5cc0a5432d44402540743ff54d0)
// Runtime types generated with workerd@1.20260911.1 2026-09-14 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	NODE_TEST_RATE_LIMITER: RateLimit;
	ALLOWED_ORIGIN: "https://vpnnew.net,https://www.vpnnew.net,http://127.0.0.1:8080,http://localhost:8080";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGIN" | "TIME_ZONE">> {}
}
